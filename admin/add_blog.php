...
if($_POST){
	...
	$sql = "INSERT INTO `blog` (`id`, `title`, `desc`, `image`) VALUES (NULL, '$_POST[title]', '$_POST[desc]', '$image');";
		//echo $sql;
		//exit();
...
<div class="content-wrapper">
	...
	<section class="col-lg-offset-1 col-lg-10 user_area">
		<div class="box">
			<div class="box-title">
				<div class="pull-left">
					<h3><i class="fa fa-edit"></i> Add a new Post</h3>
				</div>
				<div class="pull-right">
					<a href="add_product.php" class="btn btn-success"><i class="fa fa-paste"></i> Add New</a>
				</div>
			</div>
